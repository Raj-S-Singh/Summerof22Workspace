    ...
    return (
        <div className={styles['container']}>
            <div className={styles['questions']}>
                <div id={styles['questions-header']}>Navigator Deck</div>
                <Table
                ...
                >
                    <tbody>
                        {[...Array(navigatorRows).keys()].map((rowNo) => (
                            <tr>
                                {[...Array(navigatorCols).keys()]
                                    .map((colNo) => rowNo * 10 + colNo + 1)
                                    .filter(
                                        (index) => index <= props.noOfQuestions
                                    )
                                    .map((index) => (
                                        <td>
                                            <ToggleButton
            ...
            <div className={styles['options']}>
                ...
                <Form>
                    {[...Array(props.noOfOptions).keys()].map((optionNo) => (
                        <Form.Check
                            type="checkbox"
                            name="group-checkbox"
                ...
                <Toast
                    ...
                    autohide
                >
                    <Toast.Body className={styles['option-notification']}>
                        Options saved !!
                    </Toast.Body>
                </Toast>
            </div>
